...
Shader "DrawLine_"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_LeftScale("Left Scale", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_cast_0 = ((0.0*1.0 + _LeftScale)).xxx;
