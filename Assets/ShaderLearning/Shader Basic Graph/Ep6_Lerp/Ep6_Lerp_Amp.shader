	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 desaturateInitialColor11 = tex2DNode10.rgb;
				...
				float4 lerpResult13 = lerp( tex2DNode10 , float4( desaturateVar11 , 0.0 ) , -50.0);
...
ASEEND*/
//CHKSM=D974BCD72002FE30F012CE8C96ED456DA8890D9E